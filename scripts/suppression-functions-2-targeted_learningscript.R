...
elongate_values <- function( 
  ...
  #greps first argument needs a pattern - value = true returns variable names with false returns position
  ...
  #(count_variables <- grep(regex, names(d), value = T)) #Names function gets or sets the names of an object
  #(count_variables <- grep(regex, names(d_wide), value = F))
  #returns the elements of x that are not in y - REMEMBER THE ORDER MATTERS
